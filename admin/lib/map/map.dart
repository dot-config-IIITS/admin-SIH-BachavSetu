...
import 'dart:convert';
import 'dart:io';
import 'package:admin/providers/user_data_provider.dart';
    ...
    return Scaffold(
      ...
      body: FlutterMap(
        ...
        options: MapOptions(
          ...
          initialCenter: const LatLng(16.500920536169527, 80.67343331559752),
          initialZoom: 14,
          // 16.500920536169527, 80.67343331559752
          ...
          const MarkerLayer(
            markers: [
              Marker(
                width: 80.0,
                height: 80.0,
                point: LatLng(16.500920536169527, 80.67343331559752),
                child: Icon(
                  Icons.location_pin,
                  color: Colors.red,
                  size: 50.0,
